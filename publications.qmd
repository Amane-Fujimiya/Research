...
9. **On the capacity and capability of neural networks** (review, original): A paper analysing the capacity and capability of neural networks on various task and setting thereof, and so forth, considering different structures. 
...
29.  **The theory of Raman Spectroscopy** (review, reference): On the theory of Raman spectroscopy on itself, different interpretation, history, approaches, and problems. 
